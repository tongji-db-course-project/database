...
INSERT INTO member (member_id, member_name, gender, phone, birthday, points, member_tag, total_amount, level_name, status, create_time) VALUES (1, '赵一一', '女', '13900000001', TO_DATE('1992-05-18', 'YYYY-MM-DD'), 126, '高消费', 568.50, '黄金会员', '启用', SYSDATE - 90);
INSERT INTO member (member_id, member_name, gender, phone, birthday, points, member_tag, total_amount, level_name, status, create_time) VALUES (2, '钱二二', '男', '13900000002', TO_DATE('1988-09-20', 'YYYY-MM-DD'), 366, 'VIP', 1832.00, '钻石会员', '启用', SYSDATE - 180);
...
-- 不同步的话，后续业务通过 GENERATED BY DEFAULT AS IDENTITY 插入时会与种子主键冲突。
-- START WITH LIMIT VALUE 会把序列推进到当前表的最大主键 + 1，保证新插入的主键不冲突。
-- （对应后端 AppDbContext.IdentityOverrides.cs 中销售/积分模块改回 DB 自增主键。）
-- ============================================================
ALTER TABLE sale_order MODIFY (sale_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE sale_order_detail MODIFY (sale_detail_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE inventory_record MODIFY (record_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE point_record MODIFY (point_record_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE inventory MODIFY (inventory_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE member MODIFY (member_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE sys_user MODIFY (user_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE order_status_log MODIFY (log_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE purchase_order MODIFY (order_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE purchase_order_detail MODIFY (purchase_detail_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE purchase_return_order MODIFY (return_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE purchase_return_order_detail MODIFY (detail_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE return_order MODIFY (return_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE return_order_detail MODIFY (return_detail_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE transfer_order MODIFY (transfer_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE transfer_order_detail MODIFY (detail_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE stock_check_order MODIFY (check_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE stock_check_detail MODIFY (detail_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE member_coupon MODIFY (coupon_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE coupon_template MODIFY (template_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE product MODIFY (product_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE product_category MODIFY (category_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE supplier MODIFY (supplier_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE supplier_settlement MODIFY (settlement_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE warehouse MODIFY (warehouse_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE daily_settlement MODIFY (settlement_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE point_config MODIFY (config_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE sys_menu MODIFY (menu_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE sys_role MODIFY (role_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
ALTER TABLE sys_role_menu MODIFY (role_menu_id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE));
